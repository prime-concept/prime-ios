...
final class ChatPalette: ThemePalette {
    var bubbleOutcomeBackground: UIColor { Palette.shared.brandSecondary.rawValue }
    ...
    var voiceMessageRecordingCircleBackground: UIColor { Palette.shared.brandSecondary.withAlphaComponent(0.5).rawValue }
    ...
    var attachmentBadgeBackground: UIColor { Palette.shared.brandSecondary.rawValue }
    ...
    var replyPreviewIcon: UIColor { Palette.shared.black.withAlphaComponent(0.5).rawValue }
    var replyPreviewNameText: UIColor { Palette.shared.brandSecondary.rawValue }
	...
	var textContentOutcomeLinkColor: UIColor? { Palette.shared.gray5.rawValue }
	var textContentIncomeLinkColor: UIColor? { Palette.shared.brandPrimary.rawValue }
