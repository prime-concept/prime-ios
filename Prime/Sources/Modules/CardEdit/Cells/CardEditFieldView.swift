...
class CardEditFieldView: UIView {
    private lazy var titleLabel = UILabel()
    private lazy var textField: SwiftMaskField = {
        let view = SwiftMaskField()
        view.keyboardType = .numberPad
        return view
    }()

    private var model: CardEditTextFieldModel?
...
//    }
    ...
    func setup(with viewModel: CardEditTextFieldModel) {
//        self.textField.attributedTextThemed = Self.makeTitle(viewModel.title)
...
extension CardEditFieldView: Designable {
    func addSubviews() {
