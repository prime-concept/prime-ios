...
open class BottomContainerView: UIView {
	...
	lazy var pickerButton: ButtonPicker = { [unowned self] in
		let pickerButton = ButtonPicker(imagePickerConfiguration: self.configuration)
		pickerButton.setTitleColor(Palette.shared.gray5.rawValue, for: UIControl.State())
	...
	lazy var borderPickerButton: UIView = {
		...
		view.layer.borderColorThemed = Palette.shared.gray5
