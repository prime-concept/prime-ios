...
@objc public class ImagePickerConfiguration: NSObject {
  ...
  @objc public var gallerySeparatorColor = Palette.shared.black.withAlphaComponent(0.6).rawValue
  ...
  @objc public var settingsColor = Palette.shared.gray5.rawValue
  ...
  @objc public var indicatorView: UIView = {
    let view = UIView()
    view.backgroundColorThemed = Palette.shared.gray5.withAlphaComponent(0.6)
